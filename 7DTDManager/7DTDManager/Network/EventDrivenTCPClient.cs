...
namespace _7DTDManager.Network
{
    public delegate void ConnectionStatusChanged(object sender, ConnectionStatusEventArgs e);
    public delegate void DataReceived(object sender, DataReceivedEventArgs e);

    public class ConnectionStatusEventArgs : EventArgs
    {
        public ConnectionStatus ConnectionStatus { get { return _ConnectionStatus; } } private ConnectionStatus _ConnectionStatus = ConnectionStatus.Error;
        public bool Handled { get { return _Handled; } set { _Handled = true; } } private bool _Handled = false;
        public SocketError SocketError { get { return _SocketError; } } private SocketError _SocketError = SocketError.Success;

        public ConnectionStatusEventArgs()
        {
            
        }
        public ConnectionStatusEventArgs(ConnectionStatus connectionStatus) : this()
        {
            _ConnectionStatus = connectionStatus;            
        }
        public ConnectionStatusEventArgs(ConnectionStatus connectionStatus, SocketError err) : this(connectionStatus)
        {
            _SocketError = err;
        }
    }
    ...
    public class DataReceivedEventArgs : EventArgs
    {
        ...
        public DataReceivedEventArgs() : base()
        {
    ...
    /// based on: https://www.daniweb.com/software-development/csharp/code/422291/user-friendly-asynchronous-event-driven-tcp-client
    /// </summary>
    public class EventDrivenTCPClient : IDisposable
    {
        ...
        {
            DisconnectByHost(SocketError.SocketError);
        }
        private void DisconnectByHost(SocketError err)
        {
        ...
        protected virtual void Dispose(bool bAll)
        {
            tmrConnectTimeout.Close();
            tmrReceiveTimeout.Close();
            tmrSendTimeout.Close();
            this._client.Close();
        ...
        private void cbDataReceived(IAsyncResult result)
        {
            ...
            if (DataReceived != null)
                DataReceived.BeginInvoke(this, new DataReceivedEventArgs(_encode.GetString(dataBuffer, 0, bytes)), new AsyncCallback(cbDataRecievedCallbackComplete), this);
        }
        ...
        public ConnectionStatus ConnectionState
        {
            ...
            private set
            {
                ...
                if (ConnectionStatusChanged != null && raiseEvent)
                    ConnectionStatusChanged.BeginInvoke(this, new ConnectionStatusEventArgs(_ConStat), new AsyncCallback(cbChangeConnectionStateComplete), this);
            }
        }
        /// <summary>
